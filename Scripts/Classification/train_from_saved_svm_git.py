...
if __name__ == "__main__":
    ...
    clf = svm.SVC(gamma="scale", C=100.0, random_state=42)
    ...
    model_out = artifacts / "cutlery_svm.joblib"
    joblib.dump({"model": clf, "class_names": class_names, "feature_names": feature_names}, model_out)
